...
#       post tweets_url, params: { tweet: { tweet: @tweet.tweet, zombie_id: @tweet.zombie_id } }
#     end
...
#     patch tweet_url(@tweet), params: { tweet: { tweet: @tweet.tweet, zombie_id: @tweet.zombie_id } }
